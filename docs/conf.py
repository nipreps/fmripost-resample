...
latex_documents = [
    (master_doc, 'fmripost_resample.tex', 'fMRIPost-template Documentation', author, 'manual'),
]
...
man_pages = [(master_doc, 'fmripost-resample', 'fMRIPost-template Documentation', [author], 1)]
